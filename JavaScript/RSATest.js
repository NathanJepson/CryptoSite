...
function runPage2()
{
    ...
    document.getElementById("form1").innerHTML = "<input type=\"radio\" name=\"typeRSA\" value=\"1024\"> RSA 1024<br> <input type=\"radio\" name=\"typeRSA\" value=\"2048\"> RSA 2048<br> <input type=\"radio\" name=\"typeRSA\" value=\"4096\"> RSA 4096";
    document.getElementById("form2").innerHTML = ''; 
    document.getElementById("Button1").onclick = randRSA;
...
//Inspired by: https://en.wikipedia.org/wiki/RSA_(cryptosystem)
    ...
    //Input validation
    /*
    if (!Number.isInteger(p_tmp) || !Number.isInteger(q_tmp)) {
...
/* //Overwritten by bigIntRSA() function
function RunRSA()
{
...
function randRSA()
{
    document.getElementById("Text1").innerHTML = "You did it!";
}
